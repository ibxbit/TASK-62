...
# ---------------------
#   API_URL        Base URL for the API  (default: http://api:8081)
#   DATABASE_URL   PostgreSQL DSN        (default: postgresql://transitops_app:transitops_secret@db:5432/transitops)
...
export API_URL="${API_URL:-http://api:8081}"
export DATABASE_URL="${DATABASE_URL:-postgresql://transitops_app:transitops_secret@db:5432/transitops}"
